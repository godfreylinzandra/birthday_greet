...
function createCandles() {
  ...
  statusBox.textContent = 
    "30 candles lit.<br>"+"Kuya open tim mic para  mablow it candles. Dida blow hit harani ha mic okay okayyy. Pag dire ngani dumara pindota nala it Blow button HAHAHHA";
